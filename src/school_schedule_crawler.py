...
def generate_schedule_html(schedules, school_name, year, month):
    ...
    css_style = '''
        ...
        .page-header {
            ...
            align-items: center;
            background: linear-gradient(90deg, #30b4f8, #1e8fd9);
            padding: 30px 90px;
            box-shadow: 0 8px 32px rgba(48, 180, 248, 0.25);
            flex-shrink: 0;
            min-height: 80px;
        ...
        .main-content {
            background: #fff;
            border-radius: 20px;
            box-shadow: 0 8px 40px rgba(48, 180, 248, 0.25);
            margin: 20px auto;
            padding: 20px 60px;
            max-width: 2000px;
            width: 95%;
    ...
    <body>
        ...
        <div class="main-content">
            <div class="calendar-section">
                <h2 style="font-size:3.3rem; color:#30b4f8; margin-bottom:10px;">{year}년 {month}월</h2>
                {calendar_html}
            </div>
